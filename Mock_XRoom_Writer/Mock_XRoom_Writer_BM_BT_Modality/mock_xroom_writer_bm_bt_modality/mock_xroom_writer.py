...
if __name__ == "__main__":
    input_files = [
        ["./datasets/XRoom/V1_BK1/data_collection_638461160214938655_VR_.csv", "./datasets/XRoom/V1_BK1/data_collection_638461160214938655_SHIMMER_.csv"],
        ["./datasets/XRoom/V1_BK1/data_collection_638461162609580603_VR_.csv", "./datasets/XRoom/V1_BK1/data_collection_638461162609580603_SHIMMER_.csv"]
    ]
